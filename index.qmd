...
footer: '<text style="font-size: 100%">La Muerte del Aprendizaje de Máquina -- <a href="https://ggv.cl/udd-ene2024">https://ggv.cl/udd-ene2024</a></text>'
---
...
## Caso 1: Detectando la temperatura de la superficie del agua {.smaller}
...
## Caso 2: Mejorando los pronósticos de la influenza {.smaller}
...
::: {layout-align="center"}
![](fig/theory-guided-influenza-forecast.png)
:::
